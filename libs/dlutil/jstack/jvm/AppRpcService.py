...
class Client(Iface):
  ...
  def startApp(self, appMessage):
    ...
    Parameters:
     - appMessage
    """
    self.send_startApp(appMessage)
    return self.recv_startApp()

  def send_startApp(self, appMessage):
  ...
  def stopApp(self, appMessage):
    ...
    Parameters:
     - appMessage
    """
    self.send_stopApp(appMessage)
    return self.recv_stopApp()

  def send_stopApp(self, appMessage):
...
class Processor(Iface, TProcessor):
  ...
  def process_startApp(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = startApp_result()
    result.success = self._handler.startApp(args.appMessage)
  ...
  def process_stopApp(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = stopApp_result()
    result.success = self._handler.stopApp(args.appMessage)
...
class startApp_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'appMessage', (AppMessage, AppMessage.thrift_spec), None, ), # 1
  )

  def __init__(self, appMessage=None,):
  ...
  def write(self, oprot):
    ...
    if self.appMessage is not None:
      oprot.writeFieldBegin('appMessage', TType.STRUCT, 1)
      self.appMessage.write(oprot)
      oprot.writeFieldEnd()
